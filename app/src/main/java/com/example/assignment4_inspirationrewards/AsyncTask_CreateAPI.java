...
public class AsyncTask_CreateAPI extends AsyncTask<UserProfile, Void, String> {

    private static final String TAG = "AsyncTask_CreateAPI";
    ...
    AsyncTask_CreateAPI(CreateActivity createActivity) {
        this.createActivity = createActivity;
    }

    @Override
    protected void onPostExecute(String s) {
        createActivity.progressBar.setVisibility(View.INVISIBLE);

        if (s.contains("error")) {
            createActivity.sendResults(false, s);
        } else {
            createActivity.sendResults(true, s);
        }
    }
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        createActivity.progressBar.setVisibility(View.VISIBLE);
    }
}
